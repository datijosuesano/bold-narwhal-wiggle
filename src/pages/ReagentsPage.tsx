...
const ReagentsPage: React.FC = () => {
  ...
  const handleConfirmPrint = () => {
    // Ferme la modale d'aperçu pour que l'impression système soit propre
    setIsPreviewOpen(false);
    // Petit délai pour laisser le temps au DOM de restaurer la vue principale avant la capture
    setTimeout(() => {
      window.print();
    }, 300);
  };
    ...
    <div className="space-y-8 animate-in fade-in duration-300 print-container">
      ...
      <div className="flex justify-between items-center print:hidden">
        ...
        <div className="flex gap-2">
          {/* Nouveau bouton qui ouvre l'Aperçu au lieu d'imprimer directement */}
          <Button onClick={() => setIsPreviewOpen(true)} variant="outline" className="rounded-xl border-slate-200 font-bold h-11 hover:bg-slate-50">
            <Eye size={16} className="mr-1.5 text-blue-600" /> Aperçu & Exporter PDF
          </Button>
      ...
      {/* ===== TABLE DE STOCK PRINCIPALE ===== */}
      <Card id="main-inventory-table" className="shadow-lg overflow-hidden border-none bg-white rounded-2xl print:shadow-none print:border-none print:m-0 print:p-0 print:w-full">
