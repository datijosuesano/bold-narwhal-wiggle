...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      locale={fr}
      weekStartsOn={1} // Force le début de semaine au Lundi
      ...
      classNames={{
        ...
        dropdown: "rdp-dropdown bg-card border rounded-md px-1 py-0.5 text-xs focus:ring-2 focus:ring-primary outline-none",
